...
// Fetch only 30 seats for the train schedule from the Seats table
$seats_query = "SELECT seat_id, seat_number, status FROM Seats WHERE schedule_id = ? LIMIT 30";
...
<div class="container">
    <h2>Train from <?php echo $schedule['origin']; ?> to <?php echo $schedule['destination']; ?></h2>
